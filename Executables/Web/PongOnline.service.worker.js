...
/** @type {string} */
const CACHE_VERSION = '1735595366|196355429';
/** @type {string} */
const CACHE_PREFIX = 'PongOnline-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'PongOnline.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["PongOnline.html","PongOnline.js","PongOnline.offline.html","PongOnline.icon.png","PongOnline.apple-touch-icon.png","PongOnline.worker.js","PongOnline.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["PongOnline.wasm","PongOnline.pck","PongOnline.side.wasm"];
